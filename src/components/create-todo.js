...
//Render create todo form where we can add tasktitle and taskitem to create our todo
  ...
  <form onSubmit ={this.handleCreate.bind(this)}>
    <input className="forminput" type="text" placeholder="Add Task Title" ref="createTitleInput" />
    <input className="forminput" type="text" placeholder="Add Task Description" ref="createItemInput"/>
